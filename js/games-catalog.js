...
export const GAMES_CATALOG = [
  ...
  },
  {
    ...
    name: "Salto Choco",
    icon: "🦘",
    tagline: "Sube saltando de plataforma en plataforma sin caer.",
    status: "soon",
  },
  {
    id: "autos",
    ...
    icon: "🏎️",
    tagline: "Esquiva y acelera en una carrera de autos de cacao.",
    status: "soon",
  },
  {
    id: "tetris",
  ...
  },
  {
    ...
    icon: "🧠",
    tagline: "Encuentra las parejas de golosinas y personajes.",
    status: "soon",
  },
  {
    id: "penales",
